...
def train_epoch(
    ...
    for batch in dataloader:
        ...
        # params = optimizer.update(params=params, grad=grad, step=i)
...
def main():
    ...
    optimizer = None  # currently only implementing basic gradient descent
    n_epochs = 5  # minimal training
    eval_every = 1

    for epoch in range(n_epochs):
        params = train_epoch(flow_mlp, params, train_dataloader, optimizer, train_key)
